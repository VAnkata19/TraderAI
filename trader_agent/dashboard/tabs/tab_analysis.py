...
from trader_agent.config import MAX_ACTIONS_PER_DAY, OPENAI_API_KEY
from trader_agent.dashboard.helpers import save_decisions
        ...
        with col_left:
            with st.status(
                ...
                try:
                    ...
                    from trader_agent.core.chart_fetcher import (
                    ...
                    from trader_agent.core.ingestion import (
                        ingest_chart,
                        ingest_news,
                    )
            ...
            css_class = f"decision-{decision}"
            st.markdown(
                f'<p class="{css_class}">Decision: {decision.upper()}</p>',
